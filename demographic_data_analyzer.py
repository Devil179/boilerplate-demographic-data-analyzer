...
def calculate_demographic_data(print_data=True):
    ...
    country_salary_stats = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()).dropna()
    highest_earning_country = country_salary_stats.idxmax()
    highest_earning_country_percentage = round(country_salary_stats.max() * 100, 1)
